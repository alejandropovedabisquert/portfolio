    ...
    return(
        <div id="header">
            <div style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.50), rgba(0, 0, 0, 0.50)),url(${logos && logos.fondoTeclado})`}} className="bg-cover bg-fixed bg-center flex flex-col h-screen text-center items-center justify-center">
                <h1 className="bg-gradient-to-r from-primary-color tracking-widest via-secondary-color to-primary-color text-transparent bg-clip-text animate-gradient-animation font-semibold text-6xl md:text-8xl">
                    {header && header.name}
